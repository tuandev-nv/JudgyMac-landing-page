    ...
    return (
        <nav className="fixed top-0 w-full z-50 bg-black/50 backdrop-blur-2xl border-b border-white/[0.12]">
            <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
                ...
                <a href="/JudgyMac-1.0.0.dmg" className="bg-gradient-to-r from-brand-gold to-amber-500 text-black font-semibold text-sm px-5 py-2 rounded-full hover:brightness-110 transition-all duration-300 hover:scale-[1.02]">
                    Download
                </a>
            </div>
        </nav>
